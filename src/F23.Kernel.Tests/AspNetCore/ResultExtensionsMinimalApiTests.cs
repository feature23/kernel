...
public class ResultExtensionsMinimalApiTests
{
    [Fact]
    ...
    [Fact(Skip = "Need better implementation of BadRequest with ModelState for minimal APIs")]
    ...
    public void UnauthorizedResult_Returns_UnauthorizedResult()
    {
        ...
        // Assert
        Assert.IsType<UnauthorizedHttpResult>(actionResult);
    }
